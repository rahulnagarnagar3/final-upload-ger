           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <div class="padding-nav"><!-- padding-nav Begin -->
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <?php if($_SESSION['adid'] == 0 && $_SESSION['sid'] == 0 ){ ?>
                           <a href="landing.php"><i class="fa fa-calendar"></i> Book Service </a>
                        <?php }elseif(isset($_SESSION['adid'])){ ?>
                            <a href="admin/dashboard.php"><i class="fa fa-calendar"></i> Book Service </a>
                        <?php }elseif(isset($_SESSION['sid'])){?>
                            <a href="customer/dashboard.php"><i class="fa fa-calendar"></i> Book Service </a>
<?php                           }?>
                       </li>
