                                            ...
                                            <table border="1" class="table table-bordered mg-b-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php  
                                                      ...
                                                      if($row['AdminStatus']=="4")
                                                      {
                                                        echo "Collected";
                                                      }
                                                      if($row['AdminStatus']=="5")
                                                      {
                                                        echo "Scraped";
                                                      }
                                                      if($row['AdminStatus']=="6")
                                                      {
                                                        echo "Rejected";
                                                      }
                                                      if($row['AdminStatus']=="")
                                                      {
                                                        echo "Thank you for Booking Service.Wait for admin approval. ";
                                                      }
                                                ...
                                                <form name="submit" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <tr align="center">
                                                        <td colspan="2"><button type="submit" name="submit"
                                                                class="btn btn-az-primary pd-x-20">Service
                                                                Booked</button></td>
                                                    </tr>
                                                </form>
                                                <?php } ?>
