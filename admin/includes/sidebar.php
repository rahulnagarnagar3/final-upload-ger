              ...
              <ul class="metismenu" id="side-menu">
                  ...
                  <li>
                      <a href="dashboard.php">
                          <i class="fi-air-play"></i><span class="badge badge-danger badge-pill float-right"></span>
                          <span> Dashboard </span>
                      </a>
                  </li>
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="fi-layers"></i><span> Mechanics </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="add-mechanics.php">Add Mechanics</a></li>
                          <li><a href="manage-mechanics.php">Manage Mechanics</a></li>
                          <li><a href="mechanic-dashboard.php">Mechanics Dashboard</a></li>
                      </ul>
                  </li>

                  <li>
                      <a href="javascript: void(0);"><i class="fa fa-car"></i><span> Vehicle Category </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="fa fa-sticky-note"></i><span> Stock </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="fa fa-book"></i><span> Service Request </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="fa fa-taxi"></i><span> Servicing </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="fa fa-question"></i><span> Customer Enquiry </span> <span
                              class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                  ...
                  <li>
                      <a href="search-enquiry.php">
                          <i class="fa fa-search"></i><span class="badge badge-danger badge-pill float-right"></span>
                          <span> Enquiry Search </span>
                      </a>
                  </li>
