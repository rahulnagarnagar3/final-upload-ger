...
?>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-2 col-form-label" for="example-email">Full
                                                        Name</label>
                                                    <div class="col-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-2 col-form-label" for="example-email">Mobile
                                                        Number</label>
                                                    <div class="col-10">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="email" id="email" name="mobilenumber"
                                                            class="form-control" required="true" readonly='true'
                                                            value="<?php echo $row['Email'];?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-2 col-form-label" for="example-email">Registration
                                                        Date</label>
                                                    <div class="col-10">
                                                        <input type="regdate" id="regdate" name="regdate"
                                                            class="form-control" required="true" readonly='true'
