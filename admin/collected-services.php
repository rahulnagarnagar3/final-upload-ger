            ...
            <div class="content">
                                    ...
                                    <div class="col-12">
                                        <div class="p-20">
                                            <table class="table mb-0">
                                                ...
                                                <?php
                  $ret=mysqli_query($con,"select tblservicerequest.ServiceType ,tblservicerequest.ServiceNumber,tblservicerequest.Category,tblservicerequest.ID as apid, tbluser.FullName,tbluser.MobileNo,tbluser.Email from  tblservicerequest inner join tbluser on tbluser.ID=tblservicerequest.UserId where tblservicerequest.AdminStatus ='4'");
                  $cnt=1;
                ...
                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="view-service.php?aticid=<?php echo $row['apid'];?>"><i
                                                                class="fa fa-unlock"></i>View Details</a></td>
                                                </tr>
                                                <?php 
$cnt=$cnt+1;
}?>
