...
<body>
    <div class="accountbg"
        style="background: url('images/bg2.jpg');background-size: auto;background-position: center top;"></div>
    <!-- Begin page -->
    <div id="wrapper">
    ...
    echo $msg;
                                            ...
                                            <form class="form-horizontal" role="form" method="post" name="submit">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="text" name="name" id="name" rows="12" cols="15"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="email" name="email" id="email" rows="12" cols="15"
                                                            class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
              ...
              ?>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-2 col-form-label" for="example-email"><i
                                                            class="fa fa-pencil"></i>Description</label>
                                                    <div class="col-10">
                                                        <textarea name="description" value="description"
                                                            id="description" rows="12" cols="15"
            ...
            <?php include_once('includes/footerl.php');?>
        </div>
